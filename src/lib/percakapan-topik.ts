...
export const TOPIK_BAWAAN: TopikBawaan[] = [
  ...
  { kode: 'KONSULTASI_KESEHATAN', nama: 'Konsultasi Kesehatan', urutan: 6, warna: '#0891B2',
    deskripsi: 'Menanyakan keluhan, gejala, atau saran medis — termasuk menanyakan layanan mana yang sesuai untuk suatu keluhan. Bidangnya dicatat terpisah pada dimensi Poli.' },
  { kode: 'INFO_UMUM', nama: 'Informasi Umum', urutan: 7, warna: '#16A34A',
  ...
  { kode: 'KELUHAN', nama: 'Keluhan Layanan', urutan: 8, warna: '#DC2626',
